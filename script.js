...
//     let randomQuote = quotes[Math.floor(Math.random() * 3)]
//     alert(randomQuote)
// }

// quoteGenerator(["Every Action has a reaction but Opposite in direction.", "A ship is safe at the Harbour, But thats not what Ships are made for.", "You only lose when you give up."])
